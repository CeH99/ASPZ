...
-   Це призводить до **переповнення у 2038 році** (так звана *проблема
    2038 року* (19 січня 2038 року о 03:14:07 UTC.)).
...
```bash
gcc task1.c -o task1_64
```

![firstscreen](img/task1_1.png)


```bash
gcc -m32 task1.c -o task1_32
```

![secondscreen](img/task1_2.png)
